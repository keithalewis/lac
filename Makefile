LAC_ = lac_parse.c lac_variant.c lac_map.c
SRCS = lac.c $(LAC_)
OBJS = $(SRCS:.c=.o)

LAC_T = lac_parse.t.c lac_variant.t.c lac_map.t.c
...
SFLAGS = -pedantic -Wall -Wextra -Wcast-align -Wcast-qual -Wdisabled-optimization \
...
# r!make deps
lac.t.o: lac.t.c lac.h ensure.h lac_parse.h lac_variant.h
