LAC_ = lac_parse.c lac_variant.c lac_map.c lac_ffi.c lac_init.c lac_eval.c
SRCS = lac.c $(LAC_)
OBJS = $(SRCS:.c=.o)
...
lac_init.o: lac_init.c lac_map.h lac_ffi.h lac_variant.h lac_init.h
lac.o: lac.c lac.h ensure.h lac_parse.h lac_variant.h lac_map.h \
 lac_init.h lac_ffi.h
